...
def get_args():
    ...
    parser.add_argument('-image_max_len',
                        type=int,
                        default=9,
                        help="Limited number for images")
    parser.add_argument('-image_max_len1',
                        type=int,
                        default=144,
                        help="Limited number for images")
    ...
    parser.add_argument("--GCN_hidden_size",
                        default=768,
                        type=float,
                        help="Proportion of training to perform linear learning rate warmup for. "
                             "E.g., 0.1 = 10%% of training.")
    ...
    parser.add_argument('--max_doc_length', default=4, type=int,
