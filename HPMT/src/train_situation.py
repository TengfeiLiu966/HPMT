...
def main():
    ...
    if args.do_train:
        train_examples, seen_types = processor.get_examples_situation_train('/home/ltf/code/BenchmarkingZeroShot-master/BenchmarkingZeroShot/situation/train_pu_half_v0.txt') #train_pu_half_v1.txt
    ...
    # pretrain_model_dir = '/home/ltf/code/BenchmarkingZeroShot-master/BenchmarkingZeroShotData/FineTuneOnMNLI' #FineTuneOnCombined'# FineTuneOnMNLI
    pretrain_model_dir = '/home/ltf/code/scibert-master/scibert_scivocab_uncased'
    ...
    if args.do_train:
        ...
        '''load dev set'''
        eval_examples, eval_label_list, eval_hypo_seen_str_indicator, eval_hypo_2_type_index = processor.get_examples_situation_test('/home/ltf/code/BenchmarkingZeroShot-master/BenchmarkingZeroShot/situation/dev.txt', seen_types)
        ...
        '''load test set'''
        test_examples, test_label_list, test_hypo_seen_str_indicator, test_hypo_2_type_index = processor.get_examples_situation_test('/home/ltf/code/BenchmarkingZeroShot-master/BenchmarkingZeroShot/situation/test.txt', seen_types)
        ...
        iter_co = 0
        f = open('result_situation01.txt','a')
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if iter_co %50==0:
                    ...
                    # test_acc = mean_f1#result.get("f1")
                    max_overall_acc = seen_acc + unseen_acc
                    f.write(str(seen_acc) + '\t'+  str(unseen_acc) + '\t' + str(max_overall_acc))
                    f.write('\n')
