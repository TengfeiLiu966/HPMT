...
def main():
    ...
    if args.do_train:
        ...
        train_examples, seen_types = processor.get_examples_emotion_train('/home/ltf/code/BenchmarkingZeroShot-master/BenchmarkingZeroShot/emotion/train_pu_half_v0.txt') #train_pu_half_v1.txt
